    ...
    <div className="flex flex-row flex-wrap justify-center gap-8 lg:gap-6">
      ...
      >
        <div className="flex flex-col gap-6">
          <h4
            className="font-bold leading-heading m-0 p-0 w-auto md:text-2xl text-xl md:tracking-normal tracking-normal text-backgroundInversePrimary lg:text-xl"
          >
      ...
      >
        <div className="flex flex-col gap-6">
          ...
          <p
            className="hidden flex-1 md:flex-none text-sm text-backgroundInversePrimary md:block"
          >
            Thinking about buying a house without a real estate agent? Read this
            first.
          </p>
          <div className="flex items-end justify-between">
            <div className="group">
