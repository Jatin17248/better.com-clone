...
const Start = () => {
    return (
        <>
                ...
                <div id="__next">
                    <div className="" id="ld-initializer">
                         <div className="better-crate-base crate-theme-543629139">
                            <div style=
                            {{
                                 '--accent-color': '#cce9d3',
                                 '--answer-bullet-font-size': '12px',
                                 '--answer-color': '#565d5a',
                                 '--answer-link-color': '#017848',
                                 '--areadark': '#292b29',
                                 '--arealight': '#017848',
                                 '--article-tile-icon-link': '#292b29',
                                 '--back-link-color': '#017848',
                                 '--background-inverse-primary': '#073126',
                                 '--blurb-color': '#ffffff',
                                 '--calc-summary-container-background': 'var(--crate-theme-color-button-secondary-background)',
                                 '--contact-us-bg': 'var(--crate-theme-color-background)',
                                 '--contact-us-link-color': 'var(--crate-theme-color-body-muted)',
                                 '--content-post-tag-label-color': '#565d5a',
                                 '--content-post-tag-label-padding-right': '16px',
                                 '--contrast-primary': '#ffffff',
                                 '--crate-theme-color-background': '#fffdfa',
                                 '--crate-theme-color-button-primary': '#017848',
                                 '--crate-theme-color-button-secondary-background': '#017848',
                                 '--crate-theme-color-header-primary': '#292b29',
                                 '--credit-range-slider-background': 'linear-gradient(to right, #1ee07f 0, #1ee07f 33%, #017848 33%, #017848 66%, #004733 66%, #004733 100%)',
                                 '--divider-color': '#dfe0dc',
                                 '--dropdown-background-color': '#ffffff',
                                 '--email-capture-background': '#fffdfa',
                                 '--email-capture-color': '#292b29',
                                 '--email-capture-submit-background': '#e8eae6',
                                 '--entry-border-bottom': '1px solid #c7c9c5',
                                 '--global-body-color': '#565d5a',
                                 '--global-link-font-weight': 'unset',
                                 '--global-title-color': '#292b29',
                                 '--graph-background': '#fffdfa',
                                 '--graph-line': '#c7c9c5',
                                 '--graph4Secondary': '#ffbc14',
                                 '--graphTertiary': '#1ee07f',
                                 '--hoverlist-text-active': '#017848',
                                 '--hoverlist-text-primary': '#292b29',
                                 '--hoverlist-text-secondary': '#292b29',
                                 '--hoverlist-tooltip-backgroundPrimary': '#017848',
                                 '--hoverlist-tooltip-backgroundSecondary': '#017848',
                                 '--hoverlist-tooltip-textPrimary': '#ffffff',
                                 '--hoverlist-tooltip-textSecondary': '#ffffff',
                                 '--icon-color': '#ffffff',
                                 '--imagecta-background-primary-color': '#f6f6f3',
                                 '--interstitial-further-search-tab-background': '#017848',
                                 '--interstitial-further-search-tab-color': '#fffdfa',
                                 '--letter-link-color': '#017848',
                                 '--letter-link-decoration': 'none',
                                 '--nav-content-background-color': '#fffdfa',
                                 '--nav-content-background-color-dark': '#073126',
                                 '--navlink-color': '#292b29',
                                 '--related-question-border-color': '#c7c9c5',
                                 '--related-question-link-color': '#017848',
                                 '--result-interstitial-wrapper-hover': '#f6f6f3',
                                 '--resume-preapp-divider-color': '#c7c9c5',
                                 '--search-icon-fill': '#292b29',
                                 '--search-input-color': '#292b29',
                                 '--section-background-accent-color': '#e8eae6',
                                 '--section-background-backedBy-component': '#fffdfa',
                                 '--section-background-badges-component': '#e8eae6',
                                 '--section-background-getStarted-component': '#f6f6f3',
                                 '--section-background-hero-component': '#fffdfa',
                                 '--section-background-inverse-primary-color': '#073126',
                                 '--section-background-inverse-secondary-color': '#073126',
                                 '--section-background-primary-color': '#017848',
                                 '--section-background-secondary-color': '#f6f6f3',
                                 '--section-background-white-color': '#fffdfa',
                                 '--subnav-link-background-color': '#e8eae6',
                                 '--summary-border-color': '#c7c9c5',
                                 '--summary-video-heading-color': '#565d5a',
                                 '--summary-video-poster-background-color': '#017848',
                                 '--summary-video-poster-opacity': '0.2',
                                 '--svg-logo-color-ourMission-component': '#017848',
                                 '--text-active': '#017848',
                                 '--text-primary': '#292b29',
                                 '--tooltip-header-color': '#ffffff',
                                 '--transaction-toggle-button-heading': '#017848',
                                 '--video-popup-button-background': '#017848',
                                 '--video-popup-button-hover-background': '#017848',
                                 '--video-popup-description-background': '#fffdfa',
                                 '--video-popup-icon-fill': '#fffdfa',
                                 '--video-popup-icon-hover-fill': '#fffdfa',
                                 '--video-popup-poster-background': '#dfe0dc',
                                 '--video-poster-background-color': '#017848',
                                 '--video-poster-opacity': '0.2',
                                 'backgroundColor': '#fffdfa',
                                 'fontFamily': "Better Sans, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', sans-serif"
                            }}>
                                <div className="staticPage" data-page="startPage" id="startPage">
                                    <div className="css-1kq3y29"
                                    style={{
                                            width: "auto",
                                            minHeight: "100vh"
                                    }}
                                    >
                                        <div className="css-xbnxrr"
    ...
    left: "50%",
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <nav>
                                                                    <header data-testid="header-container" id="1" className="css-vz9y25 relogo">                                                                  
                                                                        <div id="header-content" data-testid="header-content" className="relogo-content css-tg17k7">
                                                                            <div id="header-left" data-testid="header-left" className="relogo-left css-8y1shf">
                                                                                <a href="/">
                                                                    ...
                                                                    <div className="css-w3gptq">
                                                                        <div aria-label="Flow Progress" aria-valuenow="0" aria-valuemin="0" aria-valuetext="undefined 0%" aria-valuemax="1" data-variation="thin" data-testid="linear-progress-container" role="progressbar" className="css-8y1shf">
                                                                            <div className="css-qdkptx">
                                                                                <div data-testid="linear-progress-bar" className="css-11zajmr">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div className="css-1e7pjxw">
                                                                            <div className="css-es8nd2">
                                                                                <div className="css-v03n8k">
                                                                                    <img data-size="medium" src="https://media.better.com/components/preapproval/industry-parity-v2/betty1.jpg" alt="Spokesperson" className="css-17hrpfd"/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div className="css-le9gc9">
                                                    <div className="css-yc7ivr">
                                                        <h1 className="css-wrqc7r">
                                                            <span>
                                                                Hi, I'm Betsy!</span>
                                                            <br/>
                                                        ...
                                                        <div className="css-1kb3csv">
                                                            <div role="radiogroup" className="css-1tlib9g">
                                                                <button aria-checked="false" role="radio" tabIndex="0" className="css-3js0wx">
                                                                    <div className="css-1etrdwv">
                                                                        <svg fill="transparent" height="36" viewBox="0 0 36 36" width="36" xmlns="http://www.w3.org/2000/svg">
                                                                            <title id="start-purchase-icon">
                                                                                Start Purchase</title>
                                                                    ...
                                                                    <span className="css-8y1shf">
                                                                        Buying a home</span>
                                                                </button>
                                                                <button aria-checked="false" role="radio" tabIndex="-1" className="css-3js0wx">
                                                                    <div className="css-1etrdwv">
                                                                        <svg fill="transparent" height="36" viewBox="0 0 36 36" width="36" xmlns="http://www.w3.org/2000/svg">
                                                                            <title id="start-refinance-icon">
                                                                                Start Refinance</title>
                                                                            <path d="M35.579 13.748 18.703.247a1.124 1.124 0 0 0-1.406 0L.42 13.747a1.125 1.125 0 0 0 .698 2.003h2.25v19.126A1.126 1.126 0 0 0 4.494 36h27.001a1.125 1.125 0 0 0 1.125-1.125V15.75h2.25a1.125 1.125 0 0 0 .709-2.002Zm-4.084-.248a1.125 1.125 0 0 0-1.125 1.125V33.75H5.619V14.625A1.126 1.126 0 0 0 4.494 13.5h-.169l13.67-10.936L31.662 13.5h-.168Z" fill="#017848">
                                                                            </path>
                                                                    ...
                                                                    <span className="css-8y1shf">
                                                                        Refinance my mortgage</span>
                                                                </button>
                                                                <button aria-checked="false" role="radio" tabIndex="-1" className="css-3js0wx">
                                                                    <div className="css-1etrdwv">
                                                                        <svg fill="transparent" height="36" viewBox="0 0 36 36" width="36" xmlns="http://www.w3.org/2000/svg">
                                                                            <title id="start-cashout-refinance-icon">
                                                                                Start Cashout Refinance</title>
                                                                    ...
                                                                    <span className="css-8y1shf">
                                                                        Get cash from my home</span>
                                                                </button>
                                                            </div>
                                                        </div>
                                                        <div className="css-1fm3nw5">
                                                            <div className="css-1aw7eg5">
                                                                <p className="css-dou93">
                                                                    $100B</p>
                                                                <p className="css-1874ra6">
                                                                    home loans funded entirely&nbsp;online</p>
                                                            </div>
                                                            <div className="css-75sbof">
                                                                <p className="css-dou93">
                                                                    400K</p>
                                                                <p className="css-1874ra6">
                                                                    Customers who chose a Better&nbsp;Mortgage</p>
                                                            </div>
                                                        </div>
                                                        <div className="css-dhmosk">
                                                            <p className="css-yshr5u">
                                                                After a few questions, you'll unlock:</p>
                                                            <div className="css-1d8k399">
                                                                <div className="css-8y1shf">
                                                                    <div className="css-d0fedg">
                                                                        <div className="css-o0lktd">
                                                                            <svg fill="none" height="22" width="22" xmlns="http://www.w3.org/2000/svg">
                                                                                <title id="percentage-outlined-icon">
                                                                                    Percentage Outlined</title>
                                                                        ...
                                                                        <div className="css-1p4jfio">
                                                                            <p className="css-1ddb1th">
                                                                                Custom mortgage rates</p>
                                                                        </div>
                                                                    </div>
                                                                    <div className="css-1y7lqy2">
                                                                        <div className="css-o0lktd">
                                                                            <svg className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-1xbrwhv" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="MonetizationOnOutlinedIcon">
                                                                    ...
                                                                    <div className="css-1y7lqy2">
                                                                        <div className="css-o0lktd">
                                                                            <svg className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-1xbrwhv" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="PhoneIphoneOutlinedIcon">
